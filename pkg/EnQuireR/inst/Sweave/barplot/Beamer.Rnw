...
% commenter la ligne pour supprimer un ÈlÈment
...
% * * * * * * * * * * * * * * * * * PICTURE * * * * * * * * * * * * * * * * * *
\usepackage{picture}
\setlength{\unitlength}{1mm}                                  % d√©finition de l'unit√©
...
% * * * * * * * * * * * * * DETAILS DE STYLE  * * * * * * * * * * * * * * * * *
\beamertemplatetransparentcovered                             % Fait afficher l'ensemble du frame en peu lisible (gris clair) d√®s l'ouverture
...
\renewcommand{\thefootnote}{\alph{footnote}}                  % num√©rotation par des lettres
...
\hypersetup{% Modifiez la valeur des champs suivants
	...
	pdftitle    = {Titre},%
	pdfsubject  = {Sujet},%
	pdfkeywords = {Mots cl√©s},%
	pdfcreator  = {PDFLaTeX},%
	pdfproducer = {PDFLaTeX},%
	pdfpagemode = {FullScreen}%                              			% ouvre le pdf directement en plein √©cran
}
...
% * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 1) MCA
% diapo 2, table des matiËres de la partie ACM seulement
...
#mod.pos.classe nombre de modalitÈs pour la classe i
...
#je fais la mÍme chose qu'en haut for nbpage varie de 1 ‡ mod.pos.classe/5
